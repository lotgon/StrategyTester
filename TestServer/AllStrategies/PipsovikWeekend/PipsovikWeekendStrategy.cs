...
{
    [RegisterAdvisor(Name = "PipsovikWeekendStrategy")]
    public class PipsovikWeekendStrategy : FxAdvisorCore.SimpleAdvisor
    {
        enum OpenMode
        {
            OnlyBuy=0, 
        ...
        class PipsovikWeekendParam : BasicParam
        {
        ...
        class StrategyState
        {
            public PipsovikWeekendParam cparam;
        ...
        public PipsovikWeekendStrategy() 
        {
        }
