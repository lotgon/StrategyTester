...
{
    public class PipsovikWeekendFunction : CommonStrategyFunction
    {
        ...
        {
            return StandardOptimizationFunction(sParam, string.Empty, new PipsovikWeekendStrategy(), new PipsovikWeekendConfigReader(), out srResult);
        }
