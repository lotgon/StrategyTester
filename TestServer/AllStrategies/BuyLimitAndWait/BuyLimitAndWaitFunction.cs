...
{
    public class BuyLimitAndWaitFunction : CommonStrategyFunction
    {
        ...
        {
            return StandardOptimizationFunction(sParam, string.Empty, new BuyLimitAndWaitStrategy(), new BuyLimitAndWaitConfigReader(), out srResult);
        }
